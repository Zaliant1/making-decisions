...
// Do not edit the code below.
let myFavoriteNumbers = [4, 8, 12, 16, 20, 24, 1353013531];
// Do not edit the code above.
...
// only checks to see if favorite number isnt 6th
...
// if favorite numbers length is 7, do this, else, not
...
for (i = 0; i < listOfNumbers.length; i++) {
  if (listOfNumbers[i] % 3 === 0) {
    console.log(`${listOfNumbers[i]} divisible by 3`);
  } else {
...
//this seems like the fizzbuzz stuff from the earlier thing so i just copy pasted it
// for loop lets i =1, and incriments til it = 50
for (let i = 1; i <= 100; i++) {
  //checks to see if divisible by 5 & 3
  if (i % 5 === 0 && i % 3 === 0) {
    ...
    //console logs number regardless
    console.log(i);
  }
}
